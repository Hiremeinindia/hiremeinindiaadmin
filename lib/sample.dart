...
import 'package:hiremeinindiaapp/auth.config.dart';
...
class _SampleState extends State<Sample> {
  ...
  String? server = remoteServerConfig["server"];
  String? serverKey = remoteServerConfig["serverKey"];
  @override
  void initState() {
    super.initState();
    ...
    emailAuth.config({"server": "serverUrl", "serverKey": ""});
