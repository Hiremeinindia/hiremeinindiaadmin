...
class CorporateCon extends StatefulWidget {
  const CorporateCon();
  @override
  State<CorporateCon> createState() => _CorporateCon();
}

class _CorporateCon extends State<CorporateCon> {
  @override
